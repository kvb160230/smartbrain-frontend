...
class Signin extends React.Component {
  ...
  onSubmitSignIn = () => {
    fetch('https://smartbrainapiapp.herokuapp.com/signin', {
      method: 'post',
      ...
      .then(users => {
        if (users.id) {
          ...
          alert('Username or Password incorrect. Make sure your credentials are correct and try again. Otherwise register a new account to get started.');
        }
      })
  }
